...
`starting_rank`, `disabled_nightmare_effects`, `nightmare_wall_always_open` and
your goal are applied to the image; everything else is handled by the client. Two seeds
