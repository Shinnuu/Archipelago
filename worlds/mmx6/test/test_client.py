...
class TestGrants(unittest.TestCase):
    ...
    def test_the_gauge_is_absolute_in_both_directions(self) -> None:
        ...
        # The cap is the game's 127, not vanilla's 64. Above 64 the bar
        # overflows its own frame, which is accepted rather than capped - a
        # 64 cap was tried on 2026-09-03 and reverted the next day.
        save = blank_save()
